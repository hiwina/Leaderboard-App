...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _fetchInput_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetchInput.js */ \"./src/modules/fetchInput.js\");\n\n\nconst api = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/';\nconst id = 'hiwi25/';\nconst addScore = async (data) => {\n  await fetch(`${api}${id}scores/`, {\n    method: 'POST',\n    body: JSON.stringify(data),\n    headers: {\n      'Content-type': 'application/json',\n    },\n  }).then((response) => response.json());\n};\n(0,_fetchInput_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addScore);\n\n//# sourceURL=webpack://leaderboard/./src/modules/addInput.js?");

/***/ }),

/***/ "./src/modules/fetchInput.js":
/*!***********************************!*\
  !*** ./src/modules/fetchInput.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst api = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/';\nconst id = 'hiwi25/';\n\nconst Scoresvalue = async () => {\n  const response = await fetch(`${api}${id}scores/`)\n    .then((res) => res.json())\n    .then((data) => data.result)\n    .catch(() => 'error');\n  return response;\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Scoresvalue);\n\n//# sourceURL=webpack://leaderboard/./src/modules/fetchInput.js?");
